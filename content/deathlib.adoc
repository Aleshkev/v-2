...
:revdate: 2019-02-16 (a. 2019-02-26)
:nofooter:
...
====
W Pythonie istnieje jeszcze jeden atak, który został wypróbowany na XXVI Olimpiadzie Informatycznej. W zadaniu oczekującym, że rozwiązanie wywoła `give_answer(n)`, pewien uczestnik zwrócił mniej-więcej taki obiekt:
...
Atak się nie powiódł, ale istnieją podejrzenia, że dodanie metody `+def __bool__(self): return True+` by było skuteczne.
